...
public class ControladorProducto {
    ...
    public void Seleccionar(JTable totalProdutcto, JTextField id, JTextField nombres, JTextField precioProducto, JTextField stock){
        int fila = totalProdutcto.getSelectedRow();
        try{
            if(fila>=0){
                id.setText(totalProdutcto.getValueAt(fila, 0).toString());
                nombres.setText(totalProdutcto.getValueAt(fila, 1).toString());
                precioProducto.setText(totalProdutcto.getValueAt(fila, 2).toString());
                stock.setText(totalProdutcto.getValueAt(fila, 3).toString());
            }
        }
        catch(Exception e){
    ...
    public void EliminarProductos(JTextField id){
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Error. No se eliminó correctamente" + e.toString());
        }
        finally{
            objetoConexion.cerrarConexion();
        }
